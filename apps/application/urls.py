...
urlpatterns = [
    ...
    path('workspace/<str:workspace_id>/application/<str:application_id>/evaluation/config', views.EvaluationConfigView.as_view()),
    path('workspace/<str:workspace_id>/application/<str:application_id>/evaluation/config/<str:config_id>', views.EvaluationConfigView.Operate.as_view()),
    path('workspace/<str:workspace_id>/application/<str:application_id>/evaluation/config/<str:config_id>/trigger', views.EvaluationConfigView.Trigger.as_view()),
    path('workspace/<str:workspace_id>/application/<str:application_id>/evaluation/result', views.EvaluationResultView.as_view()),
    path('workspace/<str:workspace_id>/application/<str:application_id>/evaluation/stats', views.EvaluationStatsView.as_view()),
]
